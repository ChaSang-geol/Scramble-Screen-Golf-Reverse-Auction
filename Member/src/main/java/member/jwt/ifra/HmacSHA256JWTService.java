...
import member.jwt.domain.JWTSerializer;
...
import static member.jwt.ifra.Base64URL.*;
...
class HmacSHA256JWTService implements JWTSerializer, JWTDeserializer {
    ...
    @Override
    public String jwtFromUser(Member user) {
    ...
    private String jwtPayloadFromUser(Member user) {
