                    ...
                    <template v-slot:default="{ active }">
                        ...
                        <v-list-item-content>
                            ...
                            <v-list-item-subtitle>
                                ...
                                BusinessPhoneNum :  {{item.businessPhoneNum }} * 
                                BiddingAmount :  {{item.biddingAmount }} * 
...
<script>
    ...
    export default {
        ...
        async created() {
            ...
            if(temp.data) {
                me.list = temp.data._embedded.biddings;
            }

            if(me.value && typeof me.value == "object") {
                var id = Object.values(me.value)[0];
                temp = await axios.get(axios.fixUrl('/biddings/' + id))
                if(temp.data) {
                    var val = temp.data
